...
namespace ProjectB {
    ...
    public partial class ProjectBDataSet : global::System.Data.DataSet {
        ...
        public partial class StudentDataTable : global::System.Data.TypedTableBase<StudentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public StudentRow AddStudentRow(string FirstName, string LastName, string Email, string RegistrationNumber, int Status) {
...
namespace ProjectB.ProjectBDataSetTableAdapters {
    ...
    public partial class StudentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Student] WHERE (([Id] = @Original_Id) AND ([FirstName] = @Original_FirstName) AND ((@IsNull_LastName = 1 AND [LastName] IS NULL) OR ([LastName] = @Original_LastName)) AND ([Email] = @Original_Email) AND ([RegistrationNumber] = @Original_RegistrationNumber) AND ([Status] = @Original_Status))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Student] ([FirstName], [LastName], [Email], [RegistrationNumber], [Status]) VALUES (@FirstName, @LastName, @Email, @RegistrationNumber, @Status);
SELECT Id, FirstName, LastName, Email, RegistrationNumber, Status FROM Student WHERE (Id = SCOPE_IDENTITY())";
...
SELECT Id, FirstName, LastName, Email, RegistrationNumber, Status FROM Student WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, FirstName, LastName, Email, RegistrationNumber, Status FROM dbo.Studen" +
                "t";
        ...
        public virtual int Delete(int Original_Id, string Original_FirstName, string Original_LastName, string Original_Email, string Original_RegistrationNumber, int Original_Status) {
        ...
        public virtual int Insert(string FirstName, string LastName, string Email, string RegistrationNumber, int Status) {
            if ((FirstName == null)) {
        ...
        public virtual int Update(string FirstName, string LastName, string Email, string RegistrationNumber, int Status, int Original_Id, string Original_FirstName, string Original_LastName, string Original_Email, string Original_RegistrationNumber, int Original_Status, int Id) {
            if ((FirstName == null)) {
                throw new global::System.ArgumentNullException("FirstName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string FirstName, string LastName, string Email, string RegistrationNumber, int Status, int Original_Id, string Original_FirstName, string Original_LastName, string Original_Email, string Original_RegistrationNumber, int Original_Status) {
            return this.Update(FirstName, LastName, Email, RegistrationNumber, Status, Original_Id, Original_FirstName, Original_LastName, Original_Email, Original_RegistrationNumber, Original_Status, Original_Id);
        }
    }
